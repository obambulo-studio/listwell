...
describe('presence checks', () => {
  it('passes when the channel field is set', async () => {
    ...
    expect(await runCheck('google-listing', cafe)).toEqual(checkResult(true))
  ...
  <html>
    ...
    <body>
      ...
      <script type="application/ld+json">
        {"@type":"LocalBusiness","name":"Seoul Bistro","address":{"streetAddress":"12 Example Street","addressLocality":"Brisbane"}}
      </script>
    </body>
  </html>`
...
describe('google listing checks', () => {
  it('applies the same review thresholds as upstream', async () => {
    const fetchImpl = mockFetch({
