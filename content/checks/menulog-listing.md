...
::fix-step{number="1" title="Apply to Join Menulog"} Visit Menulog's restaurant portal and complete the partner application. You'll need your business registration, menu, and banking details. ::
...
::fix-step{number="5" title="Promote Your Menulog Presence"} Announce your delivery availability to existing customers through social media and in-store materials. ::
...
::example{type="good" title="Pizza Restaurant - Menulog Growth"} Mario's Wood-Fired Pizza joined Menulog and saw immediate impact: 200+ new delivery orders in the first month, average order value of $45, and 25% of Menulog customers began visiting the physical restaurant after trying delivery. ::
