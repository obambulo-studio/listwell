...
::example{type="bad" title="Missed opportunity"} A popular local Thai restaurant resisted joining Deliveroo for 2 years. When they finally joined:
...
::fix-step{number="1" title="Check Deliveroo availability"} Visit [restaurants.deliveroo.com](https://restaurants.deliveroo.com) to check if Deliveroo operates in your area. Enter your postcode to confirm coverage. ::
...
::time-estimate{minutes="180" difficulty="medium"} Initial application: 30-60 minutes Full setup and menu upload: 2-3 hours Approval waiting time: 5-14 days ::
