...
::impact{type="customers" severity="high"} **46% of all Google searches** have local intent, and proper title tags can improve your local rankings by up to **20%** ::
...
::example{type="bad" title="Poor title tag impact"} "Smith & Sons" used only their business name as the title:
...
::fix-step{number="2" title="Craft the perfect title"} Use this proven formula:
...
::fix-step{number="3" title="Update your website"} Where to change your title:
...
::time-estimate{minutes="30" difficulty="easy"} Research and planning: 15 minutes Title tag updates: 10-15 minutes Google re-indexing: 1-3 weeks ::
