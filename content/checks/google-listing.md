...
::impact{type="customers" severity="high"} **97% of consumers** search online for local businesses - without a Google listing, you're invisible to them ::
...
::fix-step{number="1" title="Visit Google Business Profile"} Go to [business.google.com](https://business.google.com) and click "Manage now". Search for your business name and address. ::
...
::fix-step{number="3" title="Verify your business"} Google will verify you own the business through:
...
::fix-step{number="4" title="Complete your profile"} After verification, add:
...
::time-estimate{minutes="30" difficulty="easy"} Initial setup takes about 30 minutes. Verification can take 5-14 days if using postcard method. ::
